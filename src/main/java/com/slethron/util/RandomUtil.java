...
/**
 * Utility class used by this project to generate Random objects of various types to be used in generating
 * large collections or populations of those objects. I felt that these methods didn't properly belong in
 * their respective type classes because there are already constructors that are provided. Also, as for objects like
 * String (java.lang.String), it was necessary to have this class as a helper because their is no type class that exists
 * as a means of defining the object as the subject of the problem class.
 */
public class RandomUtil {
     ...
     * within the bounds of the board length. The fitness can be calculated for the board generated by this method
     * immediately upon retrieval it.
